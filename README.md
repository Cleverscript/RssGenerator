RssGenerator
=============
RssGenerator - это компонент дл€ Joomla 1.5! котрый позвол€ет создавать RSS ленту новостей дл€ вашего сайта или блога, включает в себ€ com_rssgenerator и mod_rssgnerator
